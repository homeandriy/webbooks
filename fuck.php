...
<div class="bg-brown-lighten bdr-b container-fluid">
    ...
    <ul class="nav nav-tabs" role="tablist" id="myTab">
        ...
        <li class="pull-right" role="presentation"><a href="#"><i class="mdi-maps-local-print-shop"></i> Print
                Listing</a></li>
    </ul>
    <!-- ./  Nav Tabs -->
</div>
                        ...
                        <div class="panel panel-default bdr-t-none">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-primary btn-sm hidden-lg hidden-md" data-toggle="collapse"
                                       href="#collapseExample" aria-expanded="false" aria-controls="collapseExample"><i
                                                class="mdi-content-add-circle-outline"></i></a>
                                    <a data-toggle="collapse" href="" aria-expanded="false"
                                       aria-controls="collapseExample"
                                       class="btn btn-primary btn-sm hidden-sm hidden-xs">+ Post a Comment</a>
                                </div>
                            </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-6 col-md-2">
                                <a href="img/thumbs/thumb1.jpg" class="boxer" title="Caption One"
                                   data-gallery="gallery">
                                    <img alt="Thumbnail" src="img/thumbs/thumb1.jpg"
                                         style=" width: 100%; display: block;">
                                </a>
                            </div>
                            <div class="col-xs-6 col-md-2">
                                <a href="img/thumbs/thumb2.jpg" class="boxer" title="Caption Two"
                                   data-gallery="gallery">
                                    <img alt="Thumbnail" src="img/thumbs/thumb2.jpg"
                                         style=" width: 100%; display: block;">
                                </a>
                            </div>
                            <div class="col-xs-6 col-md-2">
                                <a href="img/thumbs/thumb3.jpg" class="boxer" title="Caption Three"
                                   data-gallery="gallery">
                                    <img alt="Thumbnail" src="img/thumbs/thumb3.jpg"
                                         style=" width: 100%; display: block;">
                                </a>
                            </div>
                            <div class="col-xs-6 col-md-2">
                                <a href="img/thumbs/thumb4.jpg" class="boxer" title="Caption Four"
                                   data-gallery="gallery">
                                    <img alt="Thumbnail" src="img/thumbs/thumb4.jpg"
                                         style=" width: 100%; display: block;">
                                </a>
                            </div>
                        </div>
