            ...
            <div class="container-fluid mrg-tb white-bg">
                <div class="row">
                    <div class="col-md-12 section-title ">
                        <h1 class="post-title entry-title">Скачивание <strong>"<?php echo get_the_title( $post_id ) ?>
                                "</strong>. Пожалуйста ожидайте, скоро появится ссылка:</h1>
                    </div>
                    ...
                    <div class="col-md-12 section-title ">
                        <div class="list-group">
                            <a href="<?php echo get_the_permalink( $post_id ); ?>" class="list-group-item active"
                               target="_blank">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
										...
										?>
                                        <img width="128" height="180" class="media-object" src="<?php echo $url; ?>"
                                             alt="...">
                                    </div>
                    ...
                    <div class="col-md-12 section-title ">
						...
						if ( $queryInDownload->have_posts() ) {
							while ( $queryInDownload->have_posts() ) {
								...
								?>
                                <div class="list-group">
                                    <a href="<?php echo get_the_permalink(); ?>" class="list-group-item active"
                                       target="_blank">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
												<?php
												...
												?>
                                                <img width="128" height="180" class="media-object"
