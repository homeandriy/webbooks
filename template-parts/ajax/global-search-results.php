		...
		<a class="search-result-item search-result-item--book" href="<?php echo esc_url( $book_item['permalink'] ?? '' ); ?>">
			...
			<span class="search-result-item__content">
				...
				<span class="search-result-item__meta">
					<span><?php esc_html_e( 'Author:', 'webbooks' ); ?> <?php echo esc_html( $book_item['author'] ?? '' ); ?></span>
					<span><?php esc_html_e( 'Publisher:', 'webbooks' ); ?> <?php echo esc_html( $book_item['publisher'] ?? '' ); ?></span>
					<span><?php esc_html_e( 'Language:', 'webbooks' ); ?> <?php echo esc_html( $book_item['language'] ?? '' ); ?></span>
				</span>
			</span>
		</a>
	<?php endforeach; ?>
