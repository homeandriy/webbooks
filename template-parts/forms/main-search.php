...
?>
<form class="navbar-form d-none d-md-flex pos-rel">
	...
	<button type="submit" class="btn trans btn-lg" id="search-button" aria-label="<?php esc_attr_e( 'Search', 'webbooks' ); ?>">
		<i class="load-search fa fa-search" aria-hidden="true"></i>
	</button>
