...
if ( ! empty( $image_gallery_in ) ) : ?>
    <img id="zoom_03" src="<?= $image_gallery_in[0]['sizes']['thumbnail']; ?>"
         class="first" data-zoom-image="<?= $image_gallery_in[0]['url']; ?>"
         alt="<?= $image_gallery_in[0]['alt']; ?>"/>
    <div id="gallery_01">
		<?php foreach ( $image_gallery_in as $image ): ?>
            <div>
                <a href="#" data-image="<?= $image['sizes']['thumbnail']; ?>"
...
<?php elseif ( ! empty( $image_gallery_s3 ) ): ?>
    <img id="zoom_03" src="<?= $image_gallery_s3[0]; ?>"
         class="first" data-zoom-image="<?= $image_gallery_s3[0]; ?>"
