...
if ( ! empty( $image_gallery_in ) ) : ?>
	<img id="zoom_03"
		src="<?php echo $image_gallery_in[0]['sizes']['thumbnail']; ?>"
		class="first"
		data-zoom-image="<?php echo $image_gallery_in[0]['url']; ?>"
	...
	<div id="gallery_01">
		<?php foreach ( $image_gallery_in as $image ) : ?>
			<div>
				<a
					href="#"
					data-image="<?php echo $image['sizes']['thumbnail']; ?>"
...
<?php elseif ( ! empty( $image_gallery_s3 ) ) : ?>
	<img
		id="zoom_03"
		src="<?php echo $image_gallery_s3[0]; ?>"
		class="first"
		data-zoom-image="<?php echo $image_gallery_s3[0]; ?>"
