		...
		<div  class="list-group-item ">
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" >
					<img width="390" height="440" class="media-object lazy" data-original="<?php echo $thumb_url; ?>"  src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mMMDk76DwAEEgIJ2SbKSQAAAABJRU5ErkJggg==" alt="<?php echo sanitize_text_field(get_the_title())  ?>" itemprop="image">
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<div class="next-reed">
					<p><a href="<?php echo get_the_permalink(); ?>" class="btn navbar-btn btn-info navbar-right">Дальше</a></p>
				</div>
			</div> 
		</div>
	</div>
